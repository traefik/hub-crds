...
type ContentsGetter interface {
	Contents(namespace string) ContentInterface
}
...
type ContentInterface interface {
	...
	UpdateStatus(ctx context.Context, content *v1alpha1.Content, opts v1.UpdateOptions) (*v1alpha1.Content, error)
...
func newContents(c *HubV1alpha1Client, namespace string) *contents {
	return &contents{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *contents) UpdateStatus(ctx context.Context, content *v1alpha1.Content, opts v1.UpdateOptions) (result *v1alpha1.Content, err error) {
	result = &v1alpha1.Content{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("contents").
